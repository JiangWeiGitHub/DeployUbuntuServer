...
var node_download_path="https://nodejs.org/dist/v6.2.0/node-v6.2.0-linux-x64.tar.xz"
var node_package_name="node-v6.2.0-linux-x64.tar.xz"
var node_home_path="node-v6.2.0-linux-x64"

var docker_download_path="https://get.docker.com/builds/Linux/x86_64/docker-1.11.2.tgz"
var docker_package_name="docker-1.11.2.tgz"
var docker_home_path="docker"
...
\mv -r ./$node_home_path/$node_home_path/* /usr/local/
...
\mv -r ./$docker_home_path/* /usr/local/
